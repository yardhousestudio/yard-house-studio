  ...
  "hero-image-text": {
    ...
    fields: [
      ...
      { key: "primaryCtaLabel", label: "Primary button label (blank = hidden)", type: "text" },
      {
        ...
        type: "select",
        options: ["link", "whatsapp-router"],
        optionLabels: {
          link: "Standard link",
          "whatsapp-router": "Open WhatsApp router",
        },
        default: "link",
      },
      {
        ...
        type: "text",
        disabledWhen: { key: "primaryCtaMode", value: "whatsapp-router" },
        disabledHint:
          "Ignored while WhatsApp router is selected — the button opens the WhatsApp modal instead.",
      },
    ...
    fields: [
      ...
      { key: "anchor", label: "Anchor id", type: "text" },
      {
        ...
        itemSchema: [
          ...
          {
            key: "value",
            label: "Value (or display text for WhatsApp)",
            type: "text",
          },
          {
            key: "type",
            label: "Type",
            type: "select",
            options: ["email", "phone", "text", "whatsapp"],
          },
        ],
      },
      ...
      },
      {
        ...
        label: "Button link",
        type: "text",
        disabledWhen: { key: "ctaMode", value: "whatsapp-router" },
        disabledHint:
          "Ignored while WhatsApp router is selected — the button opens the WhatsApp modal instead.",
      },
    ],
