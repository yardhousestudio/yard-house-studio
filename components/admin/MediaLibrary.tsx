...
export function MediaLibrary() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {loading ? (
        <p className="font-body text-small text-ink-2">Loading…</p>
      ) : items.length === 0 ? (
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="p-3 flex flex-col gap-2">
                ...
                <p className="font-body text-label text-ink-2">
                ...
                <div className="flex gap-1.5">
                  <button
                    ...
                    className="font-body text-label text-ink-2 hover:text-ink border border-divider rounded px-2 py-1 transition-colors"
                  >
